...
/**
 * @ClassName: SdpSqlBatchUpdateRequest
...
@Getter
@Setter
public class SdpSqlBatchUpdateRequest extends BaseRequest {
    private static final long serialVersionUID = 214742701340802053L;
