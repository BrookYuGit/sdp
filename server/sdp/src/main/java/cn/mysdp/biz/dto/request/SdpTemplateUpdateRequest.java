...
/**
 * @ClassName: SdpTemplateUpdateRequest
...
@Getter
@Setter
public class SdpTemplateUpdateRequest extends BaseRequest {
    private static final long serialVersionUID = 21474270208317517L;
