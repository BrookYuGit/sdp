...
/**
 * @ClassName: SdpProjectUpdateRequest
...
@Getter
@Setter
public class SdpProjectUpdateRequest extends BaseRequest {
    private static final long serialVersionUID = 21474270437242452L;
