...
public class PropertyRegistry {
     ...
     */
    public static final String ANY_IMPLEMENTS_CLASS = "implementsClass"; //$NON-NLS-1$
    ...
    public static final String CONTEXT_JAVA_MODEL_REQUEST_PACKAGE = "javaModelRequestPackage"; //$NON-NLS-1$
    public static final String CONTEXT_JAVA_MODEL_RESPONSE_PACKAGE = "javaModelResponsePackage"; //$NON-NLS-1$
    public static final String CONTEXT_JAVA_MODEL_PACKAGE = "javaModelPackage"; //$NON-NLS-1$
    public static final String CONTEXT_JAVA_CLIENT_PACKAGE = "javaClientPackage"; //$NON-NLS-1$
    public static final String CONTEXT_JAVA_MAPPER_HELPER_PACKAGE = "javaMapperHelperPackage"; //$NON-NLS-1$
    public static final String CONTEXT_JAVA_SERVICE_PACKAGE = "javaServicePackage"; //$NON-NLS-1$
    public static final String CONTEXT_JAVA_SERVICE_IMPL_PACKAGE = "javaServiceImplPackage"; //$NON-NLS-1$
    public static final String CONTEXT_JAVA_CONTROLLER_PACKAGE = "javaControllerPackage"; //$NON-NLS-1$

    public static final String CONTEXT_JAVA_CONTROLLER_EXTRA_LINES = "javaControllerExtraLines"; //$NON-NLS-1$
    public static final String CONTEXT_JAVA_CONTROLLER_FIX_METHOD_EXTRA_LINES_FOR_EXAMPLE = "javaControllerFixMethodExtraLinesForExample";
    public static final String CONTEXT_JAVA_CONTROLLER_FIX_METHOD_EXTRA_LINES = "javaControllerFixMethodExtraLines";
