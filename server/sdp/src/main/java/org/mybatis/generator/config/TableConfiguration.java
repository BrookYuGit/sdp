...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean selectWithTopEnabled;
    ...
    public boolean isSelectWithTopEnabled() {
        return selectWithTopEnabled;
    }

    public void setSelectWithTopEnabled(boolean selectWithTopEnabled) {
        this.selectWithTopEnabled = selectWithTopEnabled;
    }
